-- candidates returns list of all primes with 3 repeating digits -> We do this because if we had 2 or 4 repeating digits,
-- then at least 1 number formed by replacing the digits will be divisible by 3.
-- Source: https://zach.se/project-euler-solutions/51/
